...
const handleCancel = async () => {
  ...
  switch (bookingType) {
    case 'hotel':
      endpoint = `http://192.168.1.113:7798/cancel-hotel-booking/${bookingId}`;
      break;
    case 'lounge':
      endpoint = `http://192.168.1.113:7798/cancel-lounge-booking/${bookingId}`;
      break;
    case 'rental':
      endpoint = `http://192.168.1.113:7798/cancel-vehicle-booking/${bookingId}`;
      break;
    case 'flight':
      endpoint = `http://192.168.1.113:7798/cancel-flight-booking/${bookingId}`;
      break;
    default:
