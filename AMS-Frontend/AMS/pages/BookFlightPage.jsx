...
const BookFlight = () => {
  ...
  const handleSearchFlights = async () => {
    ...
    try {
      ...
      let response = await axios.get('http://192.168.1.113:7798/flights', { params: params1 });
      ...
      response = await axios.get('http://192.168.1.113:7798/flights', { params: params2 });
      ...
      response = await axios.get('http://192.168.1.113:7798/flights', { params: params3 });
      ...
      response = await axios.get('http://192.168.1.113:7798/flights', { params: baseParams });
      ...
      response = await axios.get('http://192.168.1.113:7798/flights');
  ...
  const handleBookFlight = async () => {
    ...
    try {
      const response = await axios.post('http://192.168.1.113:7798/book-flight', {
        userId: userData._id,
