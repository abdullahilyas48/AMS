...
const BookHangarPage = ({ navigation }) => {
    ...
    const fetchAvailableHangars = async () => {
        try {
            const response = await axios.get('http://192.168.1.113:7798/available-hangars');
    ...
    const handleHangarBooking = async () => {
        ...
        try {
            ...
            const res = await axios.post('http://192.168.1.113:7798/hangar-reservation', bookingData, {
                headers: {
    ...
    const handleCancelReservation = async () => {
        ...
        try {
            await axios.delete(`http://192.168.1.113:7798/delete-hangar-reservation/${reservationId}`, {
