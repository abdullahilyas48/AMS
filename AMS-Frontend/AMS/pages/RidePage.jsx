...
const BookRentalService = ({ navigation }) => {
  ...
  const fetchVehicles = async () => {
    setLoading(true);
    try {
      const res = await axios.get(`http://192.168.1.113:7798/vehicles?maxPrice=${priceRange[1]}&minPrice=${priceRange[0]}`);
  ...
  const handleBooking = async () => {
    ...
    try {
      ...
      const res = await axios.post('http://192.168.1.113:7798/book-vehicles', payload);
