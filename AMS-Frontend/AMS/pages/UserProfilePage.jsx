...
const UserProfilePage = ({ navigation }) => {
  ...
  const fetchParkingBookings = async () => {
    try {
      ...
      const response = await fetch(
        `http://192.168.1.113:7798/user-parking-reservations/${userData._id}`,
        {
          method: 'GET',
          headers: {
            'Authorization': `Bearer ${token}`,
  ...
  const fetchFlightBookings = async () => {
    try {
      ...
      const response = await fetch(
        `http://192.168.1.113:7798/user-flight-bookings/${userData._id}`,
        {
          method: 'GET',
          headers: {
            'Authorization': `Bearer ${token}`,
  ...
  const fetchHotelBookings = async () => {
    try {
      ...
      const response = await fetch(
        `http://192.168.1.113:7798/user-hotel-bookings/${userData._id}`,
        {
          method: 'GET',
          headers: {
            'Authorization': `Bearer ${token}`,
  ...
  const fetchLoungeBookings = async () => {
    try {
      ...
      const response = await fetch(
        `http://192.168.1.113:7798/user-lounge-bookings/${userData._id}`,
        {
          method: 'GET',
          headers: {
            'Authorization': `Bearer ${token}`,
  ...
  const fetchVehicleBookings = async () => {
    try {
      ...
      const response = await fetch(
        `http://192.168.1.113:7798/user-vehicle-bookings/${userData._id}`,
        {
          method: 'GET',
          headers: {
            'Authorization': `Bearer ${token}`,
  ...
  const handleCancelBooking = async (bookingId, type) => {
    try {
      ...
      const response = await fetch(
        `http://192.168.1.113:7798/${endpoint}`,
        {
          method: 'DELETE',
          headers: {
            'Authorization': `Bearer ${token}`,
